...
class MySQLConnection:
    ...
    def query_db(self, query, data=None):
        with self.connection.cursor() as cursor: #the "as" is an alias function in python, "self.connection.cursor()" is being represented as "cursor"
            try:
